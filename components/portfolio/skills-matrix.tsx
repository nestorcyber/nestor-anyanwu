            ...
            <div className="animate-marquee gap-5 sm:gap-7">
              {row1.map((skill, idx) => (
                <div key={`r1-${idx}`} className="flex flex-col items-center gap-2 shrink-0 group cursor-pointer">
                  <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-xl sm:rounded-2xl bg-white text-slate-950 dark:bg-white dark:text-slate-950 border border-slate-200/80 dark:border-slate-200 shadow-[0_6px_20px_rgba(0,0,0,0.06)] dark:shadow-[0_6px_20px_rgba(255,255,255,0.12)] hover:shadow-xl hover:border-accent/80 flex items-center justify-center p-3 transition-all duration-300 group-hover:-translate-y-1">
