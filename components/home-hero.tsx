...
export default function HomeHero() {
  return (
    <section className="relative w-full h-screen flex flex-col items-center justify-center overflow-hidden pt-16 md:pt-0">
      ...
      {/* Content */}
      <div className="relative z-10 w-full max-w-7xl px-6 md:px-20 lg:px-32 flex items-center justify-center md:justify-start h-full md:pt-32">
