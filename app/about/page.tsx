  ...
  return (
    <>
      <main className="min-h-screen bg-background">
        ...
        <section className="relative w-screen h-screen flex items-center justify-center overflow-hidden -mx-[calc((100vw-100%)/2)]">
          {/* Background image */}
          <Image
            src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/about-GeDj5hoonJL0PlPoZVSwbtvdb0dEib.jpg"
            alt="Nestor Anyanwu"
            fill
          ...
          {/* Overlay with opacity - darker on mobile, lighter on desktop */}
          <div className="absolute inset-0 bg-black/50 md:bg-black/30"></div>

          {/* Text Overlay - Centered with styling */}
          <div className="relative z-10 text-center px-4">
            <h1 className="font-sans text-4xl md:text-5xl lg:text-6xl font-bold text-secondary mb-4 leading-tight">
              Who is Nestor
            </h1>
            <p className="text-secondary text-sm md:text-base font-bold tracking-widest uppercase">
        ...
        <article className="max-w-4xl mx-auto px-4 md:px-8 py-20">
          <div className="space-y-8 text-foreground max-w-none">
            ...
            <h2 className="text-lg md:text-xl font-sans font-bold text-primary mt-8 mb-3 tracking-wide">Tech Advocate</h2>
            <div>
              <p className="text-sm leading-relaxed mb-4">
            ...
            <h2 className="text-lg md:text-xl font-sans font-bold text-primary mt-8 mb-3 tracking-wide">Artificial Intelligence Enthusiast</h2>
            <div>
              <p className="text-sm leading-relaxed mb-4">
              ...
              <p className="text-sm leading-relaxed">
                His engagements often emphasize practical AI usage, encouraging individuals, students, and professionals to embrace AI as a collaborative tool that enhances creativity, problem-solving, and efficiency. By staying informed about emerging AI trends and developments, Nestor continues to position himself at the forefront of conversations shaping the future of technology in Africa and beyond.
              </p>
            </div>

            <h2 className="text-lg md:text-xl font-sans font-bold text-primary mt-8 mb-3 tracking-wide">Ingenious Designer</h2>
            <div>
              <p className="text-sm leading-relaxed mb-4">
              ...
              <p className="text-sm leading-relaxed">
                His ability to bridge technical implementation with creative execution allows him to develop solutions that are not only visually appealing but also effective in achieving organizational and user goals. Through his design work, Nestor demonstrates an understanding that great design extends beyond aesthetics. It involves creating experiences that resonate with audiences, communicate ideas effectively, and deliver measurable value.
              </p>
            </div>

            <h2 className="text-lg md:text-xl font-sans font-bold text-primary mt-8 mb-3 tracking-wide">Volunteer</h2>
            <div>
              <p className="text-sm leading-relaxed mb-4">
              ...
              <p className="text-sm leading-relaxed">
                Through volunteering, he contributes his time, skills, and expertise toward initiatives aimed at empowering students, supporting emerging professionals, and strengthening technology ecosystems. His willingness to contribute beyond personal gain reflects a belief that true growth occurs when individuals invest in the success of others. Whether supporting educational programs, technology communities, events, workshops, or awareness campaigns, Nestor approaches volunteering as an opportunity to create lasting impact and inspire positive change.
              </p>
            </div>

            <h2 className="text-lg md:text-xl font-sans font-bold text-primary mt-8 mb-3 tracking-wide">Community Builder</h2>
            <div>
              <p className="text-sm leading-relaxed mb-4">
              ...
              <p className="text-sm leading-relaxed">
                His involvement within technology communities demonstrates his commitment to fostering environments where individuals can connect, exchange ideas, develop skills, and discover opportunities. He recognizes the importance of collective progress and actively supports initiatives that bring people together around technology, entrepreneurship, digital transformation, and professional development. Through networking, mentorship, collaboration, and community engagement, he contributes to strengthening the technology ecosystem while encouraging others to participate and grow alongside their peers.
              </p>
            </div>

            <h2 className="text-lg md:text-xl font-sans font-bold text-primary mt-8 mb-3 tracking-wide">Leader</h2>
            <div>
              <p className="text-sm leading-relaxed mb-4">
              ...
              <p className="text-sm leading-relaxed">
                As a leader, he values innovation, continuous improvement, and collective success. He believes that effective leadership involves listening, learning, adapting, and creating environments where people can thrive. His ability to balance technical expertise with people-centered leadership continues to position him as an emerging voice within the technology ecosystem.
              </p>
            </div>
          </div>
        </article>
